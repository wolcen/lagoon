...
$(run-rest-tests): minishift/start build\:node-6-builder build\:node-8-builder build\:oc-build-deploy-dind build\:broker-single $(foreach image,$(deployment-test-services-rest),build\:$(image)) build\:push-minishift
...
$(run-webhook-tests): minishift/start build\:node-6-builder build\:node-8-builder build\:oc-build-deploy-dind $(foreach image,$(deployment-test-services-webhooks),build\:$(image)) build\:push-minishift
		$(eval testname = $(subst tests/,,$@))
